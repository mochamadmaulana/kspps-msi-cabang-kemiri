                        ...
                        <tbody>
                            ...
                            @foreach ($majlis as $val)
                                <tr>
                                    ...
                                    <td>{{ \GlobalHelp::str_ucfirst($val->petugas->nama_lengkap) }}</td>
                                        ...
                                        <div class="btn-group dropleft">
                                            ...
                                            <div class="dropdown-menu">
                                                ...
                                                {{-- <form action="{{ route('admin.majlis.destroy', $val->id) }}" method="POST" class="d-inline">
                                                    @csrf
                                                    @method('delete')
                                                    <button type="submit" class="dropdown-item" onclick="return confirm('Apakah yakin ingin menghapus : {{ $val->nama_majlis }} ?')"><i class="fas fa-trash"></i> Hapus</button>
                                                </form> --}}
                                            </div>
                                        </div>
                                    </td>
...
<div class="modal fade" id="PilihKetuaModal" aria-labelledby="PilihKetuaModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ route('admin.majlis.add-ketua') }}" method="POST">
                @csrf
