...
<div class="card mb-4">
    ...
    <div class="card-body">
        <div class="row justify-content-center">
            <div class="col-lg">
                <form action="{{ route('admin.majlis.store') }}" method="POST">
                    @csrf
                    <div class="row">
                        <div class="col-lg-4">
                            <!-- Kode  -->
                            <div class="form-group">
                                ...
                                <input type="text" name="kode" class="form-control @error('kode') is-invalid @enderror" value="{{ @old('kode') }}" placeholder="Contoh : 001" autofocus>
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="form-group">
                                ...
                                <select name="kategori" class="form-control @error('kategori') is-invalid @enderror">
                                    ...
                                    <option value="MMU" @if(@old('kategori') == 'MMU') selected @endif>MMU (Muharabahah)</option>
                                    <option value="MMG" @if(@old('kategori') == 'MMG') selected @endif>MMG (Murabahah)</option>
                                </select>
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="form-group">
                                ...
                                <select name="kecamatan" class="form-control @error('kecamatan') is-invalid @enderror" id="selectKecamatan">
                                    ...
                                    <option value="{{ $val_kec->id }}">{{ $val_kec->nama_kecamatan }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="form-group">
                                ...
                                <select name="petugas" class="form-control @error('petugas') is-invalid @enderror" id="selectPetugas">
                                    ...
                                    <option value="{{ $val_petugas->id }}" @if(@old('petugas') == $val_petugas->id) selected @endif>{{ $val_petugas->nama_lengkap }}</option>
                                    @endforeach
                                </select>
                                @error('petugas')<div class="invalid-feedback">{{ $message }}</span></div>@enderror
                            </div>
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" name="tanggal_berdiri" class="form-control @error('tanggal_berdiri') is-invalid @enderror" value="{{ @old('tanggal_berdiri',date('Y-m-d',time())) }}">
