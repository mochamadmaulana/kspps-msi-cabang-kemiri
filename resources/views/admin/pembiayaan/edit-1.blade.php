        ...
        <div class="card mb-4">
            ...
            <form action="{{ route('admin.anggota.store-step-1',$rc_pendaftaran->nomor_daftar) }}" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="no_identitas" class="form-control @error('no_identitas') is-invalid @enderror" value="{{ @old('no_identitas',$anggota->no_identitas) }}" placeholder="No. Identitas {{ $rc_pendaftaran->jenis_identitas }}...">
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-check form-check-inline">
                                    <input name="jenis_kelamin" class="form-check-input" type="radio" value="Laki-Laki" id="Laki-Laki" @if(@old('jenis_kelamin',$anggota->jenis_kelamin) == 'Laki-Laki') checked @endif checked>
                                    <label class="form-check-label" for="Laki-Laki"> Laki-Laki</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input name="jenis_kelamin" class="form-check-input" type="radio" value="Perempuan" id="Perempuan" @if(@old('jenis_kelamin',$anggota->jenis_kelamin) == 'Perempuan') checked @endif/>
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="alamat" class="form-control @error('alamat') is-invalid @enderror" value="{{ @old('alamat',$anggota->alamat) }}" placeholder="Alamat..">
                        ...
                        <div class="col-lg-4">
                            <!-- Provinsi -->
                            <div class="form-group">
                                <label>Provinsi <span class="text-danger">*</span></label><br>
                                ...
                                {{-- <select name="provinsi" class="form-control @error('provinsi') is-invalid @enderror" id="selectProvinsi">
                                    ...
                                    <option value="{{ $val_prov->id }}" @if(@old('provinsi',$anggota->provinsi_id) == $val_prov->id) selected @endif >{{ $val_prov->nama_provinsi }}</option>
                                    @endforeach
                                </select> --}}
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="kode_pos" class="form-control @error('kode_pos') is-invalid @enderror" value="{{ @old('kode_pos',$anggota->kode_pos) }}" placeholder="Kode Pos..">
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="rt_rw" class="form-control @error('rt_rw') is-invalid @enderror" value="{{ @old('rt_rw',$anggota->rt_rw) }}" placeholder="RT/RW..">
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="no_telepone" class="form-control @error('no_telepone') is-invalid @enderror" value="{{ @old('no_telepone',$anggota->no_telepone) }}" placeholder="No. Telepone...">
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="nominal_bayar_daftar" class="form-control @error('nominal_bayar_daftar') is-invalid @enderror" value="{{ @old('nominal_bayar_daftar',$rc_pendaftaran->nominal_bayar_daftar) }}" placeholder="Nominal Bayar Daftar...">
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-check form-check-inline">
                                    <input name="metode_bayar_daftar" class="form-check-input" type="radio" value="Cash" id="Cash" @if(@old('metode_bayar_daftar',$rc_pendaftaran->metode_bayar_daftar) == 'Cash') checked @endif checked>
                                    <label class="form-check-label" for="Cash"> Cash</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input name="metode_bayar_daftar" class="form-check-input" type="radio" value="Transfer" id="Transfer" @if(@old('metode_bayar_daftar',$rc_pendaftaran->metode_bayar_daftar) == 'Transfer') checked @endif/>
                ...
                <div class="card-footer">
                    <button type="submit" class="btn btn-md btn-block btn-success">Update & Lanjutkan</button>
                </div>
            </form>
        </div>
    </div>
