                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="no_induk" class="form-control @error('no_induk') is-invalid @enderror" value="{{ @old('no_induk') }}" placeholder="MSI0001..." autofocus>
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="no_telepone" class="form-control @error('no_telepone') is-invalid @enderror" value="{{ @old('no_telepone') }}" placeholder="0813xxxxxxxx...">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <select name="role" class="form-control @error('role') is-invalid @enderror" id="selectRole">
                                    ...
                                    <option value="{{ $val_role }}" @if (@old('role') == $val_role) selected @endif>{{ $val_role }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select name="tempat_lahir" class="form-control @error('tempat_lahir') is-invalid @enderror" id="selectTempatLahir">
                                    ...
                                    <option value="{{ $val_kb->id }}" @if (@old('tempat_lahir') == $val_kb->id) selected @endif>{{ $val_kb->nama_kota }}</option>
                                    @endforeach
                                </select>
