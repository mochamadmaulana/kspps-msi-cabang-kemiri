            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <!-- Komoditi Usaha -->
                        <li class="nav-item">
                            <a href="{{ route('admin.komoditi-usaha.index') }}" class="nav-link {{ Request::is('admin/komoditi-usaha*') ? 'active' : '' }}">
                        ...
                        <!-- Kantor -->
                        <li class="nav-item">
                            <a href="{{ route('admin.kantor.index') }}" class="nav-link {{ Request::is('admin/kantor*') ? 'active' : '' }}">
